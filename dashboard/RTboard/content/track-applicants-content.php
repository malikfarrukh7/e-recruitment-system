...
<div class="container mt-4">
    ...
    <!-- Search Form -->
    <form action="track-applicants.php" method="GET" class="application-search-form mb-4">
        ...
        <div class="form-group">
            ...
            <a href="track-applicants.php" class="btn btn-secondary">Refresh</a>
                ...
                <tbody>
                    <?php foreach ($jobApplications as $app): ?>
                        <tr>
                           ...
                           <!-- <td><button class="btn btn-primary view-qualifications" data-candidate-id="<?php echo $app['candidate_id']; ?>">View Qualifications</button></td> -->
                        ...
                        <!-- Hidden qualification details row -->
